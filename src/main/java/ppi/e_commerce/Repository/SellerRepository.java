...
public interface SellerRepository extends JpaRepository<Seller, Integer> {
    ...
    @Query("SELECT new ppi.e_commerce.Dto.SellerDto(s.id, s.businessName, s.description, s.website, s.taxId, s.phone, s.address, s.city, s.state, s.zipCode, s.country, s.logo, s.rating, s.verified, s.active, s.createdAt, u.id, u.username, COUNT(p.id)) " +
